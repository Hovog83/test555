                    ...
                    <div>
                        ...
                        <div class="col-xs-12">
                          ...
                          <section class="col col-6">
                            ...
                            {{ Form::select('status',array('ACTIVE'=>'ACTIVE','BLOCKED'=>'BLOCKED'), $users->status, $attributes = array('class'=>'form-control'))}}
                            {{ $errors->addEdit->first('status') }}
                          </section>  
                        </div>                        
                        <div class="col-xs-12">
                          <section class="col col-6">
                            {{ Form::label('code', 'code', array('class' => 'input'))}}
                            {{ Form::text('code', $users->code, $attributes = array('class'=>'form-control'))}}
                            {{ $errors->addEdit->first('code') }}
                          </section>                           
                          <section class="col col-6">
                            {{ Form::label('role', 'role', array('class' => 'input'))}}
                            {{ Form::select('role',array('USER'=>'USER','ADMIN'=>'ADMIN'), $users->role, $attributes = array('class'=>'form-control'))}}
