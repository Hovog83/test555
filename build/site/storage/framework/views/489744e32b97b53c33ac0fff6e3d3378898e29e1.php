<!DOCTYPE html>
<html lang="en-us">
<?php echo $__env->make('back.layout.main_header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<body class="">
...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="<?php echo e(asset('/assets/back/img/logo.png')); ?>" alt="SmartAdmin"> </span>
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="<?php echo e(asset('/assets/back/img/avatars/sunny.png')); ?>" alt="John Doe" class="online"/>
                </a>
...
<?php echo $__env->make('back.layout.main_nav_left', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- END NAVIGATION -->
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li> <?php echo $__env->yieldContent('breadcrumb_first', ''); ?></li>
            <li> <?php echo $__env->yieldContent('breadcrumb_second', ''); ?></li>
        </ol>
        <!-- end breadcrumb -->
...
<!-- END PAGE FOOTER -->
<!--================================================== -->
<?php echo $__env->make('back.layout.main_scripts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
